...
_G.packer_plugins = {
  ...
  ["nvim-jdtls"] = {
    loaded = true,
    path = "/home/gui/.local/share/nvim/site/pack/packer/start/nvim-jdtls",
  ...
  ["prettier.nvim"] = {
    loaded = true,
    path = "/home/gui/.local/share/nvim/site/pack/packer/start/prettier.nvim",
  ...
  ["vim-fugitive"] = {
    loaded = true,
    path = "/home/gui/.local/share/nvim/site/pack/packer/start/vim-fugitive",
